kz = self.clear(True)
data_path = '/Users/ludwigc/Desktop/nus_b600'	# select directory containing bruker data, interactive for file dialog
data_sets = [101]										# add comma separated list of experiment numbers (e.g. [1, 2, 3])
...
for k in range(lds):									#
    ...
    self.nd.nmrdat[0][k].proc.invert_matrix[1] = True
